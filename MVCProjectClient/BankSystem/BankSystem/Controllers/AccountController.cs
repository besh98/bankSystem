...
namespace BankSystem.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Admin()
        {
            ...
            var result = new List<CardsAdminResult>();

            foreach (var card in client.GetCardsByAdmin())
            {
                var newCard = new CardsAdminResult();
            ...
            foreach (var card in client.GetCardsWithoutUser())
            {
                var newCard = new CardsAdminResult();
            ...
            //List<CardsResult> result = Mapper.Map <CardsView[], List<CardsView>>
